...
const MaintainanceDetails = () => {
    ...
    return (
        <section className='bg-[#F9FAFB]'>
            <Navbar />
            <div className="px-8 md:px-28 py-14 max-w-[95rem] mx-auto">
                <div className="flex items-center space-x-3 cursor-pointer mb-10" onClick={() => navigate("/")}>
                    <BiArrowBack className='text-[#667085]' />
                    <p className='text-[#475467]'>Back</p>
                </div>
...
export default MaintainanceDetails